...
설명
/*
6기준으로 4*9=3*12=2*18=1*36 이거니까

제곱근 보다 큰 약수는(9,12,18,36) 제곱근(6)보다 작은 약수(1,2,3,4)에서 구할 수 있다.
36의 약수 자체가 1, 2, 3, 4, 6, 9, 12, 18, 36이고 36의 제곱근이 6이니까 그걸 기준으로 짝을 맞추면 36이 되는데, 
만약에 6 이후의 값을 모른다고 하면 제곱근 앞에 값들만(1234) 이용해서 뒤에 있는 약수들을 구할수 있다.
(36/1=36 , 36/2=18, 36/3=12, 36/4= 9) 그래서 제곱근까지만 반복문을 돌려도 되는거네용
