...
*/
const PART4_3 = `INSERT INTO user(name, email) VALUES ('person1', 'person1@gamil.com')`;
...
*/
const PART4_8 = `SELECT content.title, user.name FROM content LEFT OUTER JOIN user ON content.userId = user.id WHERE user.name IS NOT NULL`;
...
const PART4_10 = `INSERT INTO content(title, body, userId) VALUES('new title', 'new body', 1)`;
