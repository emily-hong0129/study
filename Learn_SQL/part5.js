...
*/
const PART5_2_2 = `SELECT user.name, user.email, role.name as roleName FROM user LEFT OUTER JOIN role ON user.roleId = role.id`;
...
*/
const PART5_2_5 = `SELECT title FROM content INNER JOIN user ON content.userId = user.id WHERE user.name = 'jiSungPark'`;
...
const PART5_2_6 = `SELECT category.name FROM category
                    ...
                    INNER JOIN user ON content.userId = user.id WHERE user.name = 'JiSungPark'
                    `;
...
*/
const PART5_2_9 = `SELECT COUNT(userId) as ContentCount FROM content
                    INNER JOIN user ON userId = user.id
...
*/
const PART5_2_10 = `SELECT user.name as name, COUNT(userId) as ContentCount FROM content
                    RIGHT JOIN user ON userId = user.id
                    GROUP BY user.name
                    `;
